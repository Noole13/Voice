...
// تسجيل أمر /setup كـ Slash Command تلقائياً عند تشغيل البوت
client.once('ready', async () => {
    ...
    const commands = [
        new SlashCommandBuilder()
            .setName('setup')
            .setDescription('إرسال لوحة تحكم الرومات المؤقتة (خاص بالمالك والإدارة)')
    ];
        ...
        if (interaction.commandName === 'setup') {
            ...
            try {
                const embed = new EmbedBuilder()
                    ...
                    .setFooter({ text: '3RB SYSTEM • Voice Management', iconURL: interaction.guild.iconURL() });
